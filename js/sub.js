 ...
 headers: { Authorization: "KakaoAK 49589a251b92786e2edf497d0092b009" }
  ...
  .done(function (msg) {
    ...
    for (var i = 0; i < boxs.length; i++) {
      ...
      $("#liste >.boxe").eq(i).append('<a href="#">' + "<img src='" + msg.documents[i].thumbnail + "'/>" + "</a>");
      $("#liste >.boxe").eq(i).append("<h3>" + '<a href="sub2.html">' + msg.documents[i].title + "</a>" + "</h3>");
      $("#liste >.boxe").eq(i).append("<h6>" + msg.documents[i].authors + "</h6>");
  
  
      var str = msg.documents[i].contents;
      var str2 = str.substring(0, 60);
  
      $("#liste >.boxe").eq(i).append("<p>" + '<a href="sub2.html">' + str2 + "</a>" + "</p>");
      $("#liste >.boxe").eq(i).append('<a href="#" class="btn">' + "click" + "</a>");
